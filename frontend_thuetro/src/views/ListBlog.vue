...
<template>
  <div>
    ...
    <Breadcrumb :titlePage="'Tin tức'"></Breadcrumb>
    <section class="service-section padd-1">
      <div class="container">
        <div class="sec-title center">
          <h2>Danh sách <span> bài viết</span></h2>
        </div>
        <div class="row">
          <div class="col-8">
            <section class="news-section" v-if="blogs && blogs.content">
              <div class="row">
                <div
                  ...
                  :key="blog.ID"
                >
                  <ItemBlog :item="blog"></ItemBlog>
                </div>
              </div>
              <div class="d-flex justify-content-center">
                <paginate
                  v-if="blogs"
                  :page-count="blogs.totalPages"
...
import ItemBlog from "@/views/components/ItemBlog.vue";
